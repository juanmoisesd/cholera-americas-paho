...
### APA 7ª Edición
```
de la Serna Tuya, J. M. (2026). Cholera Cases in the Americas: Interactive Data Portal (PAHO). GitHub. https://github.com/juanmoisesd/cholera-americas-paho
```

### Chicago Autor-Fecha
```
de la Serna Tuya, Juan Moisés. 2026. "Cholera Cases in the Americas: Interactive Data Portal (PAHO)." GitHub. https://github.com/juanmoisesd/cholera-americas-paho.
```

### BibTeX
```bibtex
@misc{delaserna2026_choleraameri,
  author       = {de la Serna Tuya, Juan Moisés},
  title        = {Cholera Cases in the Americas: Interactive Data Portal (PAHO)},
  year         = {2026},
...
TI  - Cholera Cases in the Americas: Interactive Data Portal (PAHO)
PY  - 2026
PB  - GitHub
UR  - https://github.com/juanmoisesd/cholera-americas-paho
...
### Vancouver / IEEE
```
de la Serna Tuya JM. Cholera Cases in the Americas: Interactive Data Portal (PAHO). GitHub; 2026. Available: https://github.com/juanmoisesd/cholera-americas-paho. ORCID: 0000-0002-8401-8018.
```
