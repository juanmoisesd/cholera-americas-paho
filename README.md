...
[![Pages](https://img.shields.io/badge/Live-Dashboard-brightgreen)](https://juanmoisesd.github.io/cholera-americas-paho/)


## Overview

Interactive data portal: Cholera cases in the Americas. Country profiles, comparisons. Source: PAHO.
...
> de la Serna Tuya, J.M. (2026). *Cholera in the Americas — PAHO Data Portal*. GitHub. https://github.com/juanmoisesd/cholera-americas-paho
...
**APA 7**
> De la Serna Tuya, J. M. (2025). *Interactive data portal: Cholera cases in the Americas. Country profiles, comparisons. Source: PAHO.* [Dataset]. GitHub. https://github.com/juanmoisesd/cholera-americas-paho

**BibTeX**
```bibtex
@dataset{delaserna2025_cholera_americas_paho,
...
## Overview
This repository contains data and resources related to **cholera americas paho**. It is part of an open science initiative to share research findings and datasets with the global scientific community.
